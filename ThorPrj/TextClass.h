...
public:
	...
	bool SetObjectsNum(int ObjectNum, ID3D11DeviceContext* deviceContext);

	//bool SetPolygon(int, ID3D11DeviceContext*);
	//bool SetResolution(int, ID3D11DeviceContext*);

	bool SetResolutionNum(int width, int height, ID3D11DeviceContext* deviceContext);
